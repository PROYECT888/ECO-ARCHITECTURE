    ...
    <div className="min-h-screen bg-brand-dark flex flex-col font-body selection:bg-brand-gold/20 selection:text-brand-gold antialiased overflow-x-hidden" onClick={() => { setShowTooltip(null); setSelectedFoodCostDay(null); setSelectedLaborCostDay(null); }}>
      ...
      <main className="flex-grow p-4 sm:p-10 lg:p-14 xl:p-20 space-y-12 sm:space-y-16 lg:space-y-20">
        ...
        <div className="max-w-[1600px] mx-auto mt-6">
          <div className="bg-brand-alert/10 border-2 border-brand-alert/30 p-6 rounded-[30px] sm:rounded-[40px] flex items-center gap-4 animate-pulse shadow-[0_0_30px_rgba(255,49,49,0.1)] w-full">
        ...
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="h-[280px] sm:h-[320px] w-full">
            <Co2EmissionsTemplateChart
              data={[
                { day: 'Sun', foodWaste: 500, water: 9, energy: 1428 },
                { day: 'Mon', foodWaste: 375, water: 7, energy: 1092 },
                { day: 'Tue', foodWaste: 400, water: 7, energy: 1134 },
                { day: 'Wed', foodWaste: 425, water: 7, energy: 1176 },
                { day: 'Thu', foodWaste: 450, water: 8, energy: 1260 },
                { day: 'Fri', foodWaste: 550, water: 10, energy: 1470 },
                { day: 'Sat', foodWaste: 600, water: 10, energy: 1554 }
              ]}
              benchmark={1500}
            />
          </div>
