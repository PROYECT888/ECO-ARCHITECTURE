      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
          <div className="flex flex-col items-center md:items-start gap-2">
            <span className="text-lg font-geometric font-bold tracking-tight text-white">Ecometricus</span>
            <span className="text-[10px] uppercase tracking-widest text-gray-500">Luxury F&B Sustainability Intelligence</span>
          </div>
