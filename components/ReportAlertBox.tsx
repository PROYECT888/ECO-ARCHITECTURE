...
const ReportAlertBox: React.FC<ReportAlertBoxProps> = ({ title, issue, suggestion, type }) => {
    // High-Alert Styling Logic
    const isKPI = type === 'kpi';
    const borderColor = isKPI ? 'border-brand-alert' : 'border-brand-alert'; // Both are "Red" alerts now per request? "High-Alert UI"
    // User requested "Category Name in Red" for Alert Side, "Suggestion Name in Green" for Solution Side.
