    ...
    const { data: signUpData, error: signUpError } = await supabase.auth.signUp({
      ...
      options: {
        data: {
          full_name: fullName,
          role: role,
          legal_consent: acceptTerms // ✅ SAVE CONSENT IN METADATA
        },
    ...
    try {
        ...
        try {
          ...
          const { error: profileError } = await supabase
            ...
            .upsert({
              ...
              legal_consent: acceptTerms // ✅ SAVE THE ACTUAL CHECKBOX VALUE
            }, {
              onConflict: 'id'
            });
      ...
      try {
        onLogin({
          ...
          legal_consent: isSignUp ? acceptTerms : (authUser.user_metadata?.legal_consent || false), // ✅ USE ACTUAL VALUE
        });
