  ...
  return (
    <nav className="sticky top-0 z-50 bg-brand-dark/95 backdrop-blur-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
        <div
          className="flex flex-col items-center justify-center gap-0 sm:gap-1 cursor-pointer group"
          onClick={() => handleNavigate(Page.HOME)}
        >
          <div className="h-[40px] sm:h-[48px] w-auto flex items-center justify-center">
            <img src="/assets/Icon2_original.png" alt="Ecometricus Logo" className="h-full w-auto object-contain" />
          </div>
          <span className="text-[10px] sm:text-xs font-geometric font-bold tracking-[0.2em] text-[#D4AF37] group-hover:text-brand-gold transition-colors uppercase">
            Ecometricus
          </span>
        </div>
