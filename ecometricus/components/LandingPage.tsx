...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative min-h-screen flex items-start overflow-hidden pt-32 sm:pt-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <div className="space-y-6 sm:space-y-10 max-w-3xl text-left">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-geometric font-bold leading-[1.1] text-white drop-shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-4">
              <button
                className="bg-[#39ff14] text-brand-dark hover:brightness-110 px-10 py-4 rounded-full font-bold transition-all uppercase tracking-widest text-xs shadow-xl transform hover:scale-105"
      ...
      <section className="py-20 sm:py-32 bg-brand-dark">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8">
            {metrics.map((m, i) => (
              <div key={i} className="metric-card w-[180px] sm:w-[200px] aspect-square p-6 sm:p-8 rounded-2xl bg-brand-dark/40 flex flex-col items-center justify-center text-center group hover:bg-brand-gold/5 transition-all duration-500 border border-white/5">
